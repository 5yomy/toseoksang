...
window.SITE = {
  ...
  // ── 예약 ──────────────────────────────────────────────
  // 실시간예약 페이지 주소. 비워두면 '실시간예약' 버튼이 전화걸기로 바뀝니다.
  // [확인] 네이버 플레이스에 연결되어 있는 온다(ONDA) 예약 페이지입니다.
  bookingUrl:  'https://booking.pension.onda.me/137862/calendar',
  ...
  // ── 사업자 정보 (푸터 표기) ───────────────────────────
  company:     '토석상',
  ceo:         '○○○',                // ← 대표자명 입력 (네이버에 공개되어 있지 않아 비워둡니다)
